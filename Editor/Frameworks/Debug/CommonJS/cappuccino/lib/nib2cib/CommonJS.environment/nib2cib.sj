...
p;10;NSButton.jt;11498;@STATIC;1.0;I;17;AppKit/CPButton.jI;19;AppKit/CPCheckBox.jI;16;AppKit/CPRadio.ji;8;NSCell.ji;11;NSControl.jt;11383;objj_executeFile("AppKit/CPButton.j", NO);
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_isBordered"), new objj_ivar("_bezelStyle"), new objj_ivar("_title"), new objj_ivar("_normalImage"), new objj_ivar("_alternateImage"), new objj_ivar("_allowsMixedState"), new objj_ivar("_imagePosition"), new objj_ivar("_keyEquivalent"), new objj_ivar("_keyEquivalentModifierMask")]);
objj_registerClassPair(the_class);
...
p;13;NSColorWell.jt;1576;@STATIC;1.0;I;20;AppKit/CPColorWell.ji;8;NSCell.ji;11;NSControl.jt;1504;objj_executeFile("AppKit/CPColorWell.j", NO);
objj_executeFile("NSCell.j", YES);
objj_executeFile("NSControl.j", YES);
{
...
p;11;NSControl.jt;2185;@STATIC;1.0;I;18;AppKit/CPControl.ji;8;NSCell.ji;8;NSView.jt;2119;objj_executeFile("AppKit/CPControl.j", NO);
objj_executeFile("NSCell.j", YES);
objj_executeFile("NSView.j", YES);
{
...
p;18;NSCustomResource.jt;2668;@STATIC;1.0;I;29;AppKit/_CPCibCustomResource.jt;2615;objj_executeFile("AppKit/_CPCibCustomResource.j", NO);
var FILE = require("file");
{
...
p;14;NSExpression.jt;8675;@STATIC;1.0;I;25;Foundation/CPExpression.jt;8626;

objj_executeFile("Foundation/CPExpression.j", NO);

{var the_class = objj_allocateClassPair(CPExpression_keypath, "NSKeyPathExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{var the_class = objj_allocateClassPair(CPExpression_constant, "CPKeyPathSpecifierExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPKeyPathSpecifierExpression__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
    var keyPath = objj_msgSend(aCoder, "decodeObjectForKey:", "NSKeyPath");
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPKeyPathSpecifierExpression").super_class }, "initWithValue:", keyPath);
    return self;
}
},["id","CPCoder"])]);
}

{var the_class = objj_allocateClassPair(CPKeyPathSpecifierExpression, "NSKeyPathSpecifierExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPExpression_constant__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
...
{var the_class = objj_allocateClassPair(CPExpression_constant, "NSConstantValueExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPExpression_function__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
...
{var the_class = objj_allocateClassPair(CPExpression_function, "NSFunctionExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPExpression_set__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
    var type = objj_msgSend(aCoder, "decodeIntForKey:", "NSExpressionType"),
...
{var the_class = objj_allocateClassPair(CPExpression_set, "NSSetExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
{var the_class = objj_allocateClassPair(CPExpression_self, "NSSelfExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPExpression_variable__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
...
{var the_class = objj_allocateClassPair(CPExpression_variable, "NSVariableExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("NS_initWithCoder:"), function $CPExpression_aggregate__NS_initWithCoder_(self, _cmd, aCoder)
{ with(self)
{
...
{var the_class = objj_allocateClassPair(CPExpression_aggregate, "NSAggregateExpression"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
...
p;8;NSFont.jt;2526;@STATIC;1.0;I;15;AppKit/CPFont.jt;2487;objj_executeFile("AppKit/CPFont.j", NO);
var OS = require("os"),
...
{ with(self)
{
    ...
    if (name === IBDefaultFontFace)
    {
        var size = objj_msgSend(aFont, "size"),
            bold = objj_msgSend(aFont, "isBold"),
            italic = objj_msgSend(aFont, "isItalic");
        if (size === IBDefaultFontSize && !bold && !italic)
            return nil;
        else
            return objj_msgSend(objj_msgSend(CPFont, "alloc"), "_initWithName:size:bold:italic:", objj_msgSend(CPFont, "systemFontFace"), (size == IBDefaultFontSize ? CPFontDefaultSystemFontSize : size), bold, italic);
    }
...
p;13;NSFormatter.jt;151;@STATIC;1.0;t;133;

{var the_class = objj_allocateClassPair(CPObject, "NSFormatter"),
meta_class = the_class.isa;objj_registerClassPair(the_class);
}

p;14;NSFoundation.jt;299;@STATIC;1.0;i;9;NSArray.ji;14;NSExpression.ji;14;NSDictionary.ji;17;NSMutableString.ji;7;NSSet.jt;197;objj_executeFile("NSArray.j", YES);
...
p;9;NSImage.jt;1195;@STATIC;1.0;I;16;AppKit/CPImage.jt;1155;objj_executeFile("AppKit/CPImage.j", NO);
{
...
p;18;NSLevelIndicator.jt;5218;@STATIC;1.0;I;25;AppKit/CPLevelIndicator.jt;5169;objj_executeFile("AppKit/CPLevelIndicator.j", NO);
{
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _minValue = objj_msgSend(aCoder, "decodeDoubleForKey:", "NSMinValue") || 0;
        ...
        _levelIndicatorStyle = objj_msgSend(aCoder, "decodeIntForKey:", "NSIndicatorStyle") || 0;
        _tickMarkPosition = objj_msgSend(aCoder, "decodeIntForKey:", "NSTickMarkPosition") || 0;
        _numberOfTickMarks = objj_msgSend(aCoder, "decodeIntForKey:", "NSNumberOfTickMarks") || 0;
        _numberOfTickMarks = objj_msgSend(aCoder, "decodeIntForKey:", "NSNumberOfMajorTickMarks") || 0;
    }
    return self;
}
},["id","CPCoder"])]);
...
p;19;NSNumberFormatter.jt;1229;@STATIC;1.0;I;30;Foundation/CPNumberFormatter.jt;1175;objj_executeFile("Foundation/CPNumberFormatter.j", NO);
{
...
p;15;NSPopUpButton.jt;3297;@STATIC;1.0;I;22;AppKit/CPPopUpButton.ji;8;NSMenu.jt;3239;objj_executeFile("AppKit/CPPopUpButton.j", NO);
objj_executeFile("NSMenu.j", YES);
{
...
p;19;NSPredicateEditor.jt;3375;@STATIC;1.0;I;26;AppKit/CPPredicateEditor.jt;3325;objj_executeFile("AppKit/CPPredicateEditor.j", NO);
{
...
p;14;NSRuleEditor.jt;4330;@STATIC;1.0;I;21;AppKit/CPRuleEditor.jI;20;AppKit/CPTextField.ji;8;NSCell.ji;11;NSControl.jt;4232;objj_executeFile("AppKit/CPRuleEditor.j", NO);
...
p;10;NSSlider.jt;3549;@STATIC;1.0;I;17;AppKit/CPSlider.jt;3508;objj_executeFile("AppKit/CPSlider.j", NO);
{
...
p;15;NSTableColumn.jt;5349;@STATIC;1.0;I;22;AppKit/CPTableColumn.jI;26;AppKit/CPTableHeaderView.jI;17;AppKit/CPButton.jt;5250;objj_executeFile("AppKit/CPTableColumn.j", NO);
...
p;26;NSUserDefaultsController.jt;1626;@STATIC;1.0;I;33;AppKit/CPUserDefaultsController.jt;1569;objj_executeFile("AppKit/CPUserDefaultsController.j", NO);
{
