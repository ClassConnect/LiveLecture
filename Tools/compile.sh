...
function build_release {
  ...
  # Copy the index.php from Tools to the directory
  cp Tools/standard_index.php $1.release/index.php
  bold_echo "Done building release version of $1"
  set_uses_frameworks $1 false
}

# If they are in the Tools directory, we go up one dir for easy access to
# the Editor and Presenter directories
